 ...
 * @param {Function} callback returns error (optional)
 */
SkoopDb.prototype.remove = function(skoop, callback) {
	var self = this;
 ...
 */
SkoopDb.prototype.fetch = function(query, callback) {
	this.db.open(function(err, db) {
		if (err != null)
			return callback(err, null);
