var Skoop = exports.Skoop = function(user, properties) {
	// data members
	// all non object members are treated as strings
	this._id = null;
	this.created = Date.now();
	this.updated = this.created;
	// TODO: should user be an object with an identifier and email?
	this.user = user + '';
	this.members = [];
	this.vendor = null;
	this.category = null;
	...
	if (typeof properties === "object") {
		...
		this.tags = properties['tags'] != null ? properties['tags'] : null;
	}
};
