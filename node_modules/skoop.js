var Skoop = function(user, properties) {
	...
	if (typeof properties === "object") {
		...
		this.created = properties['created'] != null ? properties['created'] : new Date().getTime();
		this.updated = properties['updated'] != null ? properties['updated'] : new Date().getTime();
		...
		this.price = properties['price'] != null ? properties['price'] * 1.0 : null;
...
Skoop.prototype.dataType = function(attribute) {
	if (attribute === "_id" || attribute === "user" || attribute === "label" ||
	    attribute === "url" || attribute === "vendor" || attribute === "category" ||
	    attribute === "product" || attribute === "image")
	    return "string";
	else if (attribute === "created" || attribute === "updated" || attribute === "dateToExpire")
		return "date";
	else if (attribute === "members" || attribute === "tags")
		return "array";
	else if (attribute === "price")
		return "float";
	else if (attribute === "terms")
		return "object";
}
