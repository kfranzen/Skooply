...
function MakeJoinSkoop(data,parent,i)
{
    ...
    temp_join_button = shmCreateElement('div', {id: 'join_text'+ i}, styleJoinSkoopButton);
    temp_social_panel.appendChild(temp_join_button);
    $('#join_text'+ i).text("Click to Join");
    
    // Wire up button
    $('#join_text'+ i).bind('click',function() {JoinSkoop(data['_id']);});
