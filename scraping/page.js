...
function createImagePicker(parent_to_append)
{
    ...
    $("#image_change_left").attr("src", 'http://localhost:2404/SkooplyWS/Skooply/scraping/image_pick_left.png');
    ...
    $("#image_change_right").attr("src", 'http://localhost:2404/SkooplyWS/Skooply/scraping/image_pick_right.png');
